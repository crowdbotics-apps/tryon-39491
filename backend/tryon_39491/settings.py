"""
Django settings for tryon_39491 project.
...
WSGI_APPLICATION = 'tryon_39491.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tryon_39491 API",
    "DESCRIPTION": "API documentation for tryon_39491 App",
    "VERSION": "v1",
}
